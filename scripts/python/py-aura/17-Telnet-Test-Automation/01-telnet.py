...
def get_list_of_files_by_ip(ip_addr, user, password):
	cmd = "ls"
...
def main():
	#get_list_of_files_by_ip(HOST, user, password)
	#get_sys_uptime_by_ip("127.0.0.1", "auradev", "jnjnuh")
	#get_process_status_by_name(service, HOST, user, password, ps_cmd)
	#get_hostname_by_ip("127.0.0.1", "auradev", "jnjnuh")
