...
ACCESS_TOKEN_URL = 'KA.eyJ2ZXJzaW9uIjoyLCJpZCI6ImpnY1g1cjBOUXkrbEgvQm1Da0N4UWc9PSIsImV4cGlyZXNfYXQiOjE1MTM4NDc3MjksInBpcGVsaW5lX2tleV9pZCI6Ik1RPT0iLCJwaXBlbGluZV9pZCI6MX0.v3YdTToaPHjYH95TkUbn8Y2S_BBRWIeKc6hXxz_SVi0'
...
class SimpleOAuthClient(oauth.OAuthClient):
    ...
    def __init__(self, server, port=httplib2.HTTP_PORT, request_token_url='',
        ...
        self.connection = httplib2.HTTPConnection(
